...
public Fish (String _name, String _sex, String _food, String _ecosystem, String _espece, int _age, int _sleepHours, boolean _exotic, boolean _sterelized, int _finNumber, String _water) {
...
public void Dormir() {
    ...
    System.out.println("il est mouiller sur dans l'eau");
}
